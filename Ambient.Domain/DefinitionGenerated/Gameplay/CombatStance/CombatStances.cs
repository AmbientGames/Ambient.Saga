...
namespace Ambient.Domain {
    ...
    public partial class CombatStances {
        
        private CombatStance[] combatStanceField;
        
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("CombatStance")]
        public CombatStance[] CombatStance {
            get {
                return this.combatStanceField;
            }
            set {
                this.combatStanceField = value;
            }
        }
    }
}
