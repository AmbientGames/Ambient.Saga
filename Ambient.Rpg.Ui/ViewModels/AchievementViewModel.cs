...
public partial class AchievementViewModel : ObservableObject
{
    ...
    private IWorldStateRepository _worldRepository; // supplied by the host application (optional, for persistence)
    private ISteamAchievementService? _steamService; // supplied by the host application (optional, for Steam sync)
    ...
    public AchievementViewModel(ArcInteractionContext context)
    {
        _context = context;
        RefreshAchievements();
    }
