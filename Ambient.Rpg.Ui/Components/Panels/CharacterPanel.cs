...
public class CharacterPanel
{
    ...
    private void RenderColumn1_StatsAndArchetype(RpgMainViewModel viewModel)
    {
        // Position
    ...
    private void RenderColumn2_EquipmentAndCompanions(RpgMainViewModel viewModel)
    {
    ...
    private void RenderColumn3_FactionsAndStats(RpgMainViewModel viewModel)
    {
        // Faction Reputation
        ...
        if (viewModel.Avatar != null)
        {
            ...
            if (ImGui.BeginTable("LifetimeStatsTable", 2, ImGuiTableFlags.SizingFixedFit))
            {
                ...
                // Quest state lives in the arc transaction log; the Journal shows it.
    ...
    private void RenderEquippedItems(RpgMainViewModel viewModel)
    {
    ...
    private void RenderCurrentSelection(RpgMainViewModel viewModel)
    {
    ...
    private void RenderFactionSection(RpgMainViewModel viewModel)
    {
    ...
    private void RenderFactionEntry(Ambient.Domain.Faction faction, RpgMainViewModel viewModel)
    {
