...
public class DialogueModal
{
    ...
    private void RenderDialogueContent(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, ref bool isOpen)
    {
    ...
    private void RenderCharacterHeader(RpgMainViewModel viewModel, CharacterViewModel character)
    {
    ...
    private void RenderActiveDialogue(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, ref bool isOpen)
    {
    ...
    private void RenderChoices(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, float height)
    {
        if (_currentState == null) return;
    ...
    private void RenderChoice(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, DialogueChoiceOption choice, int index)
    {
    ...
    private void RenderContinueButton(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
        ImGui.Spacing();
        ImGui.Spacing();
    ...
    private async Task InitializeDialogueAndSetLoadingAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
        try
        {
    ...
    private async Task SelectChoiceAndSetLoadingAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, string choiceId)
    {
        ...
        System.Diagnostics.Debug.WriteLine($"[DialogueModal] ArcRef: {character.ArcRef}");
        try
        {
    ...
    private async Task AdvanceDialogueAndSetLoadingAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
    ...
    private async Task InitializeDialogueAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
        ...
        try
        {
            System.Diagnostics.Debug.WriteLine($"[DialogueModal] Starting dialogue with character {character.CharacterRef}, ArcRef: {character.ArcRef}");
    ...
    private async Task SelectChoiceAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager, string choiceId)
    {
    ...
    /// </summary>
    private bool ProcessPendingEvents(System.Collections.IList eventsList, RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
    ...
    private async Task AdvanceDialogueAsync(RpgMainViewModel viewModel, CharacterViewModel character, ModalManager modalManager)
    {
        if (viewModel.CurrentWorld == null || viewModel.Avatar == null)
            return;
    ...
    private async Task RefreshDialogueStateAsync(RpgMainViewModel viewModel, CharacterViewModel character)
    {
        if (viewModel.CurrentWorld == null || viewModel.Avatar == null)
        {
