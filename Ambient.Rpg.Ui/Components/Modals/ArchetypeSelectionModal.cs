...
public class ArchetypeSelectionModal
{
    ...
    public void Render(RpgMainViewModel viewModel, ImGuiArchetypeSelector? selector, ref bool isOpen)
    {
        if (!isOpen) return;
    ...
    private void RenderArchetypeDetails(AvatarArchetype archetype, string currencyName, RpgMainViewModel viewModel)
    {
