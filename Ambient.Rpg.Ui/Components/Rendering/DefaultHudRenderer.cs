...
public class DefaultHudRenderer : IHudRenderer
{
    ...
    private void RenderResourceBars(RpgMainViewModel viewModel)
    {
    ...
    private void RenderHotkeyRow(RpgMainViewModel viewModel, ActivePanel activePanel, Vector2 displaySize)
    {
