using Ambient.Rpg.Ui.Components;
...
namespace Ambient.Rpg.Ui.Components.Examples;
...
public static class GameplayOverlayExamples
{
    ...
    /// </summary>
    public static void RenderLoopWithPauseMenuPolling(GameplayOverlay overlay, ModalManager modalManager, RpgMainViewModel viewModel)
    {
        // In your render loop:
...
{
    public void Render(RpgMainViewModel viewModel, ActivePanel activePanel, Vector2 displaySize, bool hasActiveToastMessages = false)
    {
