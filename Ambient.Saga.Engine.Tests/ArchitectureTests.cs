...
public class ArchitectureTests
{
    ...
    //    var infrastructureNamespace = "Ambient.Saga.Engine.Infrastructure.Persistence";
    ...
    //    // Arrange
    //    var presentationAssembly = Assembly.Load("Ambient.Saga.Presentation.UI");
    //    var domainServicesNamespace = "Ambient.Saga.Engine.Domain.Services";
    ...
    {
        // Arrange
        var applicationAssembly = Assembly.Load("Ambient.Saga.Engine");
        var infrastructureNamespace = "Ambient.Saga.Engine.Infrastructure.Persistence";

        // Act: Check all handler types
        var handlerTypes = applicationAssembly.GetTypes()
            .Where(t => t.Namespace != null &&
                       t.Namespace.StartsWith("Ambient.Saga.Engine.Application.Handlers"));
