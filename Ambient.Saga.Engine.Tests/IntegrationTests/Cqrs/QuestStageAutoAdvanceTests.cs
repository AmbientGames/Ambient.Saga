...
///
/// QuestStageProgressionBehavior is the driver: after any saga command, stages whose
...
public class QuestStageAutoAdvanceTests : IDisposable
{
    ...
    public async Task CompletedObjectives_AutoAdvanceStages_ButCompletionWaitsForTheQuestGiver()
    {
        ...
        var committed = (await _repository.GetOrCreateInstanceAsync(avatar.Id, "AUTO_SAGA"))
        ...
        Assert.Contains(committed, t =>
            t.Type == SagaTransactionType.QuestStageAdvanced &&
        ...
        committed = (await _repository.GetOrCreateInstanceAsync(avatar.Id, "AUTO_SAGA"))
            .GetCommittedTransactions();
        ...
        var finalCommitted = (await _repository.GetOrCreateInstanceAsync(avatar.Id, "AUTO_SAGA"))
            .GetCommittedTransactions();
    ...
    private World CreateTestWorld()
    {
        ...
        var targetTrigger = new SagaTrigger
        {
        ...
        var returnTrigger = new SagaTrigger
        {
        ...
        var world = new World
        {
            ...
            WorldTemplate = new WorldTemplate
            {
                Gameplay = new GameplayComponents
                {
                    ...
                    Quests = new[] { autoQuest, twoObjectiveQuest },
        ...
        world.SagaTriggersLookup[sagaArc.RefName] = new List<SagaTrigger> { targetTrigger, returnTrigger };
