...
public class FactionReputationIntegrationTests : IDisposable
{
    ...
    public void ReputationChanged_Transaction_UpdatesFactionReputation()
    {
        ...
        // Create Arc instance and state machine
        ...
        var arcTemplate = new Arc
        {
            RefName = "TEST_ARC",
            DisplayName = "Test Arc"
        };

        var stateMachine = new ArcStateMachine(arcTemplate, new List<ArcTrigger>(), _world);
    ...
    public void DialogueCondition_ReputationLevel_FiltersChoicesCorrectly()
    {
        ...
        // Create mock Arc state with reputation at Friendly level (3000)
