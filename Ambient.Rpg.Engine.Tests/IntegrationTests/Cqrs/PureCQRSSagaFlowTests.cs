...
/// <summary>
/// Demonstrates the pure CQRS pattern for Arc interactions.
///
/// KEY PRINCIPLE:
...
/// 2. Arc creates transactions (spawns, triggers, etc.)
...
///
/// This is how you "put Arcs away and never think about them again" - the pattern is stable.
/// </summary>
...
public class PureCQRSSagaFlowTests : IDisposable
{
    ...
    {
        _output.WriteLine("=== PURE CQRS ARC FLOW ===");
        _output.WriteLine("");
        ...
        // ================================================================
        // STEP 1: COMMAND - Move avatar (Arc decides what happens)
        // ================================================================
        _output.WriteLine("--- STEP 1: COMMAND (Write) ---");
        _output.WriteLine("Action: UpdateAvatarPosition ? Arc center");
        _output.WriteLine("");
        ...
        var moveResult = await _mediator.Send(new UpdateAvatarPositionCommand
        {
            AvatarId = avatarId,
            ArcRef = "TownSquare",
            Latitude = 35.6762,  // Arc center - both triggers will activate
            Longitude = 139.6503,
            Avatar = avatar
        });
        ...
        // ================================================================
        // STEP 2: QUERY - Ask Arc "what can I do?"
        // ================================================================
        ...
        _output.WriteLine($"  Arc discovered: {interactions.ArcDiscovered}");
        ...
        _output.WriteLine("? Arc decides WHAT is available (server authoritative)");
        _output.WriteLine("");
        _output.WriteLine("This is the stable pattern. Put Arcs away and never think about them again.");
    }
