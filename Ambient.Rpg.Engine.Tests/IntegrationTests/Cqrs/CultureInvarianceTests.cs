...
/// ArcTransaction.SetData/GetData were partially culture-sensitive. On comma-decimal
...
public class CultureInvarianceTests
{
    ...
    public void BattleTransaction_WrittenUnderCommaDecimalCulture_RoundTripsExactly()
    {
        RunUnderCulture("nb-NO", () =>
        {
            ...
            var battleStartedTx = BattleTransactionHelper.CreateBattleStartedTransaction(
                Guid.NewGuid().ToString(), "TestArc", Guid.NewGuid(), Guid.NewGuid(),
    ...
    [Fact]
    public void ArcTransaction_SetData_WritesInvariant_AndReadsBackUnderAnyCulture()
    {
        ...
        // to 0 (characters relocating to arc origin) when this failed
    ...
    [Fact]
    public void ArcTransaction_GetData_StillReadsLegacyCurrentCultureValues()
    {
