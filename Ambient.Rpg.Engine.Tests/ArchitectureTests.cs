...
public class ArchitectureTests
{
    ...
    //{
    //    // Arrange
    //    var presentationAssembly = Assembly.Load("Ambient.Rpg.Presentation.UI");
    //    var infrastructureNamespace = "Ambient.Rpg.Engine.Infrastructure.Persistence";
    ...
    //    // Arrange
    //    var presentationAssembly = Assembly.Load("Ambient.Rpg.Presentation.UI");
    //    var domainServicesNamespace = "Ambient.Rpg.Engine.Domain.Services";
    ...
    {
        // Arrange
        var applicationAssembly = Assembly.Load("Ambient.Rpg.Engine");
        var infrastructureNamespace = "Ambient.Rpg.Engine.Infrastructure.Persistence";

        // Act: Check all handler types
        var handlerTypes = applicationAssembly.GetTypes()
            .Where(t => t.Namespace != null &&
                       t.Namespace.StartsWith("Ambient.Rpg.Engine.Application.Handlers"));
