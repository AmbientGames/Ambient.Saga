...
public class MockDialogueStateProvider : IDialogueStateProvider
{
    ...
    // Real avatars carry Health on a 0..1 scale (archetypes may spawn slightly over-full,
    // e.g. 1.05) — the mock mirrors that scale so evaluator tests can't drift onto a
    // fictional percent-scale actual.
