...
/// <summary>
/// Adapter for AvatarInfoModal to work with the Modal Registry Pattern.
/// </summary>
public class AvatarInfoModalAdapter : IModal
{
    ...
    {
        System.Diagnostics.Debug.WriteLine("[AvatarInfoModal] Opening");
    }
    ...
    public void Render(object? context, ref bool isOpen)
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("[AvatarInfoModal] Invalid context, closing");
            isOpen = false;
        }
    }
    ...
    {
        System.Diagnostics.Debug.WriteLine("[AvatarInfoModal] Closed");
    }
}
