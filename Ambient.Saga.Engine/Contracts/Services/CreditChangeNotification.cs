...
/// <summary>
/// Raised by <see cref="IAvatarUpdateService"/> whenever a Saga transaction mutates
/// <c>avatar.Stats.Credits</c>. Intended for hosts that need to forward the change
/// to an authoritative server so the server-side balance stays in sync with Saga's
/// local view.
/// </summary>
...
/// <param name="TransactionId">Saga TransactionId. Host should pass this to the
