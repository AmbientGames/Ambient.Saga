...
public class AvailableInteractionsResult
{
    ...
    /// <summary>
    /// Whether the arc itself has been discovered
    /// </summary>
    public bool ArcDiscovered { get; set; }

    /// <summary>
    /// Current Arc status
    /// </summary>
    public ArcStatus ArcStatus { get; set; }
}
...
public class CharacterInteractionOptions
{
    ...
    /// <summary>
    /// Whether the interacting avatar is the owner of this arc.
...
public class ActiveTriggerInfo
{
    ...
    /// Trigger status
    /// </summary>
    public ArcTriggerStatus Status { get; set; }
