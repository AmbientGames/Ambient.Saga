...
/// Database location: %APPDATA%\{PublisherFolder}\{ProductRef}\saves\{WorldConfigRef}.db
/// </summary>
internal class WorldStateDatabase : IDisposable
{
    ...
    public WorldStateDatabase(IGameSettings gameSettings, string worldConfigurationRef, ILogger<WorldStateDatabase>? logger = null)
    {
        ...
        mapper.Entity<ArcInstance>().Id(x => x.InstanceId);
        ...
        // These are now tracked via ArcState (event-sourced from transactions)
