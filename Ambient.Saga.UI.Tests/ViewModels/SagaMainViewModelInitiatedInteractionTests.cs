...
/// the sandbox subscribes to SagaMainViewModel.DialogueRequested and opens the
/// dialogue modal when the arbiter picks a character. The Schema 3D games interact
...
/// </summary>
public class SagaMainViewModelInitiatedInteractionTests
{
    #region Test doubles
    ...
    private sealed class RecordingMediator : IMediator
    {
        ...
        public Task<TResponse> Send<TResponse>(IRequest<TResponse> request, CancellationToken cancellationToken = default)
        {
            ...
            {
                return Task.FromResult((TResponse)(object)new SagaCommandResult
                {
                    Successful = false,
    ...
    private static SagaMainViewModel CreateReadyViewModel(RecordingMediator mediator)
    {
        var viewModel = new SagaMainViewModel(
            new WorldProvider(),
    ...
    {
        // Schema-3D-game-style host: interaction is clicking the character's model;
    ...
    {
        // Schema-3D-game-style host after the assault feature: subscribes ONLY
    ...
    public async Task AssaultWinner_RaisesAssaultRequested_WithoutStartingDialogue()
    {
        ...
        Assert.Equal("TestSaga", assaulted.SagaRef);
